...
@section('nameheader')
    <h1><span class="glyphicon glyphicon" aria-hidden="true"></span>Halaman Informasi <br>
         <small>disini anda dapat melihat halaman-halaman berisikan informasi penting dalam website anda</small></h1>
@endsection
        ...
        <table class="table table-bordered table-striped table-hover">
            <tr>
                <thead class="main-color-bg">
                    ...
                    <th><center>Judul Halaman</center></th>
...
@section('dropdown create')
        <div class="dropdown create nav navbar-right">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            <li><a type="button" data-toggle="modal" data-target="#addPages">Tambah Halam Baru</a></li>
          </ul>
        </div>
@endsection
<!-- Modal edit -->
