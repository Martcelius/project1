...
@section('nameheader')
<h1><span class="glyphicon glyphicon" aria-hidden="true"></span>Ubah Logo Utama Website <br>
     <small>Disini anda dapat merubah logo website anda</small></h1>
@endsection
...
@section('content')
    <div class="panel panel-default">
      <div class="panel-heading main-color-bg">
        <h3 class="panel-title">Silahkan memilih logo baru untuk website anda</h3>
      </div>
      <div class="panel-body">
          <form>
              ...
              <div class="form-group form-inline">
                <label> Teks ALternatif Logo </label>
                  <input type="text" placeholder="Teks Untuk logo" class="form-control">
              </div>
