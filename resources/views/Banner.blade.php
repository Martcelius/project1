...
@section('nameheader')
    <h1><span class="glyphicon glyphicon" aria-hidden="true"></span>Banner <br>
         <small>disini anda dapat melihat banner yang di tampilkan di halaman tertentu website anda</small></h1>
@endsection
...
@section('dropdown create')
        <div class="dropdown create nav navbar-right">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            <li><a type="button" data-toggle="modal" data-target="#addbanner">Tambah Banner</a></li>
          </ul>
        </div>
@endsection
<!-- Modal Banner -->
