...
@section('nameheader')
    <h1><span class="glyphicon glyphicon" aria-hidden="true"></span>Manajemen Produk <br>
         <small>Disini anda dapat melihat kategori dari setiap produk yang akan di website anda</small></h1>
@endsection
...
@section('sidebar')
    ...
    <a href="#" class="list-group-item"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Manajemen Pesanan</a>
@endsection
      ...
      <table class="table table-bordered table-striped table-hover">
          <tr>
              <thead class="main-color-bg">
                  ...
                  <th><center>Lihat Kategori</center></th>
          ...
          <tr>
              ...
              <td>
                  <center>
                  <a href="/LihatKategori"><button type="button" name="button" class="btn btn-xs main-color-bg"><span ></span>Lihat</button></a>
                  </center>
              </td>
              <td>
                  <center>
...
@section('dropdown create')
        <div class="dropdown create nav navbar-right">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            <li><a type="button" data-toggle="modal" data-target="#addkategori">Tambah Kategori</a></li>
          </ul>
        </div>
@endsection
<!-- Modal Kategori -->
<div class="modal fade" id="addkategori" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <textarea name="jenis" class="form-control"  placeholder="Jenis Kategori"></textarea>
        </div>
        <div class="form-group">
