...
@section('nameheader')
    <h1><span class="glyphicon glyphicon" aria-hidden="true"></span>Slide Show <br>
         <small>disini anda dapat melihat slideshow yang di tampilkan di halaman home website anda</small></h1>
@endsection
...
@section('dropdown create')
        <div class="dropdown create nav navbar-right">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
            <li><a type="button" data-toggle="modal" data-target="#addslideshow">Tambah slideshow</a></li>
          </ul>
        </div>
@endsection
<!-- Modal slideshow -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Tambah Slideshow</h4>
      </div>
